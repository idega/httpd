...
#
apr_builddir=/root/download/startuppack/httpd-2.2.8/srclib/apr
apr_builders=/root/download/startuppack/httpd-2.2.8/srclib/apr/build

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.2.12
...
LINK         = $(LIBTOOL) $(LTFLAGS) --mode=link $(LT_LDFLAGS) $(COMPILE) -version-info 2:12:2 $(ALL_LDFLAGS) -o $@
