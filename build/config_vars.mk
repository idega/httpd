...
SSL_LIBS = -lssl -lcrypto -L/usr/kerberos/lib -ldl -lz
...
AP_LIBS = /root/download/startuppack/httpd-2.2.8/srclib/pcre/libpcre.la /root/download/startuppack/httpd-2.2.8/srclib/apr-util/libaprutil-1.la -lsqlite3 -lexpat /root/download/startuppack/httpd-2.2.8/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /root/download/startuppack/httpd-2.2.8
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/root/download/startuppack/httpd-2.2.8/srclib/apr/include -I/root/download/startuppack/httpd-2.2.8/srclib/apr-util/include -I$(top_builddir)/server -I$(top_srcdir)/modules/proxy/../generators -I/usr/kerberos/include -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /root/download/startuppack/httpd-2.2.8/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/sh
RSYNC = /usr/bin/rsync
MODULE_DIRS = aaa cache database debug filters loggers metadata proxy ssl http dav/main generators dav/fs dav/lock mappers
MODULE_CLEANDIRS = arch/win32 echo experimental ldap test
PORT = 80
...
MKDEP = $(CC) -MM
INSTALL_PROG_FLAGS =
DSO_MODULES = authn_file authn_dbm authn_anon authn_dbd authn_default authz_host authz_groupfile authz_user authz_dbm authz_owner authz_default auth_basic auth_digest disk_cache mem_cache dbd dumpio ext_filter include filter substitute deflate log_config log_forensic logio env mime_magic cern_meta expires headers ident usertrack unique_id setenvif version proxy proxy_connect proxy_ftp proxy_http proxy_ajp proxy_balancer ssl mime dav status autoindex asis info cgid dav_fs dav_lock vhost_alias negotiation dir imagemap actions speling userdir alias rewrite
APR_BINDIR = /usr/local/apache2/bin
APR_INCLUDEDIR = /root/download/startuppack/httpd-2.2.8/srclib/apr/include
APR_VERSION = 1.2.12
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /root/download/startuppack/httpd-2.2.8/srclib/apr-util/include
APU_VERSION = 1.2.12
